...
uint8_t accel_buffer[aclgyro_buf_length]; // Buffer for reading the acceleration values
...
void init_AclGyro()
{
    memset(accel_buffer,0,aclgyro_buf_length);
...
void ACL_ReadRawValues(unsigned char *raclRawVals)
{
